...
#include "eavlOpDispatch_1_1_int.h"
...
struct cpuTopologyGatherMapOp_1_0_1_regular
{
...
template <class F, class I0, class O0>
struct cpuTopologyGatherMapOp_1_0_1_explicit
{
    static void call(int n,
...
template <class F, class I0, class O0>
__global__ void
topologyGatherMapKernelRegular_1_0_1(int n,
                           eavlRegularConnectivity reg,
                           I0 *i0, int i0div, int i0mod, int i0mul, int i0add,
                           O0 *o0, int o0mul, int o0add,
                           int *idx, int idxmul, int idxadd,
...
template <class F, class I0, class O0>
struct gpuTopologyGatherMapOp_1_0_1_regular
{
    static void call(int n,
                     eavlRegularConnectivity &reg,
                     ...
                     F &functor)
    {
        ...
        dim3 blocks (32,           1, 1);
        topologyGatherMapKernelRegular_1_0_1<<< blocks, threads >>>(n,
                                                           reg,
...
template <class F>
void callTopologyGatherMapKernelStructured_1_0_1(int n,
                          eavlRegularConnectivity reg,
                          ...
                          F &functor)
{
    ...
    // run the kernel
    eavlDispatch_1_1_int<gpuTopologyGatherMapOp_1_0_1_regular>(n,
                                                  eavlArray::DEVICE,
                                                  reg,
...
template <class F, class I0, class O0>
__global__ void
topologyGatherMapKernelExplicit_1_0_1(int n,
                             eavlExplicitConnectivity conn,
                             I0 *i0, int i0div, int i0mod, int i0mul, int i0add,
                             O0 *o0, int o0mul, int o0add,
                             int *idx, int idxmul, int idxadd,
...
template <class F, class I0, class O0>
struct gpuTopologyGatherMapOp_1_0_1_explicit
{
    static void call(int n,
                     eavlExplicitConnectivity &conn,
                     I0 *d_i0, int i0div, int i0mod, int i0mul, int i0add,
                     ...
                     F &functor)
    {
        ...
        dim3 threads(numThreads,   1, 1);
        dim3 blocks (32,           1, 1);
        topologyGatherMapKernelExplicit_1_0_1<<< blocks, threads >>>(n,
                                                            conn,
                                                            d_i0, i0div, i0mod, i0mul, i0add,
                                                            d_o0, o0mul, o0add,
                                                            idx, idxmul, idxadd,
...
template <class F>
void callTopologyGatherMapKernelExplicit_1_0_1(int n,
                            eavlExplicitConnectivity &conn,
                            eavlArray *i0, int i0div, int i0mod, int i0mul, int i0add,
                            eavlArray *o0, int o0mul, int o0add,
                            eavlArray *idx, int idxmul, int idxadd,
                            F &functor)
{
    ...
    // run the kernel
    eavlDispatch_1_1_int<gpuTopologyGatherMapOp_1_0_1_explicit>(n,
                                                    eavlArray::DEVICE,
                                                    conn,
                                                    i0, i0div, i0mod, i0mul, i0add,
                                                    o0, o0mul, o0add,
...
// ****************************************************************************
// Class:  eavlTopologyGatherMapOp_1_0_1<F>
//
// Purpose:
...
///   topology, no input arrays on the (sparsely listed) destination topology,
...
// ****************************************************************************
template <class F>
class eavlTopologyGatherMapOp_1_0_1 : public eavlOperation
{
  protected:
    eavlCellSet     *cells;
  ...
  public:
    ...
    virtual void GoCPU()
    {
        ...
        if (elExp)
        {
            eavlDispatch_1_1_int<cpuTopologyGatherMapOp_1_0_1_explicit>(n,
                                   eavlArray::HOST,
        ...
        else if (elStr)
        {
            ...
            eavlDispatch_1_1_int<cpuTopologyGatherMapOp_1_0_1_regular>(n,
                                 eavlArray::HOST,
                                 conn,
                                 inArray0.array, inArray0.div, inArray0.mod, inArray0.mul, inArray0.add,
                                 outArray0.array, outArray0.mul, outArray0.add,
    ...
    virtual void GoGPU()
    {
        ...
        if (elExp)
        {
            callTopologyGatherMapKernelExplicit_1_0_1(n,
                                   elExp->GetConnectivity(topology),
                                   inArray0.array, inArray0.div, inArray0.mod, inArray0.mul, inArray0.add,
                                   outArray0.array, outArray0.mul, outArray0.add,
                                   indicesArray.array, indicesArray.mul, indicesArray.add,
        ...
        {
            callTopologyGatherMapKernelStructured_1_0_1(n,
