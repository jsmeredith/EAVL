...
template <class CONN>
struct eavlCombinedTopologyScatterMapOp_CPU
{
...
// ****************************************************************************
// Class:  eavlCombinedTopologyScatterMapOp
//
// Purpose:
...
class eavlCombinedTopologyScatterMapOp : public eavlOperation
{
  protected:
    eavlCellSet *cells;
    ...
    F            functor;
  public:
    eavlCombinedTopologyScatterMapOp(eavlCellSet *c, eavlTopology t,
    ...
    virtual void GoCPU()
    {
        ...
        if (elExp)
        {
            ...
            eavlOpDispatch<eavlCombinedTopologyScatterMapOp_CPU<eavlExplicitConnectivity> >(n, conn, s_inputs, d_inputs, outputs, indices, functor);
        }
        else if (elStr)
        {
            eavlRegularConnectivity conn = eavlRegularConnectivity(elStr->GetRegularStructure(),topology);
            eavlOpDispatch<eavlCombinedTopologyScatterMapOp_CPU<eavlRegularConnectivity> >(n, conn, s_inputs, d_inputs, outputs, indices, functor);
        }
    }
    virtual void GoGPU()
    {
        ...
        if (elExp)
        {
            ...
            eavlOpDispatch<eavlCombinedTopologyScatterMapOp_GPU<eavlExplicitConnectivity> >(n, conn, s_inputs, d_inputs, outputs, indices, functor);
        ...
        {
            eavlRegularConnectivity conn = eavlRegularConnectivity(elStr->GetRegularStructure(),topology);
            eavlOpDispatch<eavlCombinedTopologyScatterMapOp_GPU<eavlRegularConnectivity> >(n, conn, s_inputs, d_inputs, outputs, indices, functor);
        }
#else
...
template <class IS, class ID, class O, class INDEX, class F>
eavlCombinedTopologyScatterMapOp<IS,ID,O,INDEX,F> *new_eavlCombinedTopologyScatterMapOp(eavlCellSet *c, eavlTopology t,
                                                                                      IS is, ID id, O o, INDEX indices, F f) 
{
    return new eavlCombinedTopologyScatterMapOp<IS,ID,O,INDEX,F>(c,t,is,id,o,indices,f);
}
